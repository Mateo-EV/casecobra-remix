...
const userImagesExtensions = ["png", "png", "png", "jpg", "jpg"]
            ...
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex-col items-center sm:items-start">
                <div className="space-y-2">
                  {qualities.map((quality, i) => (
                    <li className="flex gap-1.5 items-center text-left" key={i}>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  {userImagesExtensions.map((extensions, i) => (
                    <img
                      src={`/users/user-${i + 1}.${extensions}`}
              ...
              <div className="glex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <CheckIcon className="size-4 stroke-[3px] text-green-600" />
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              <CheckIcon className="size-5 text-green-600 inline mr-1.5" />
            ...
            <li className="w-fit">
              <CheckIcon className="size-5 text-green-600 inline mr-1.5" />5
              year print warranty
            </li>
