      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={{ ...globalStyles.text, marginTop: 24 }}>
          ...
          <Section style={globalStyles.defaultPadding}>
          ...
          <Section style={globalStyles.defaultPadding}>
            <Row style={{ display: "inline-flex gap-16", marginBottom: 40 }}>
              <Column style={{ width: 170 }}>
                <Text style={globalStyles.paragraphWithBold}>Order Number</Text>
                <Text style={track.number}>{orderId}</Text>
              </Column>
              <Column style={{ marginLeft: 20 }}>
                <Text style={globalStyles.paragraphWithBold}>Order Date</Text>
